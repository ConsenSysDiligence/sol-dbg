...
export class ViewError<State> extends Error {
    constructor(public readonly view: View<any, any, any, any>, public readonly state: State, msg: string = "") {
 ...
 */
export abstract class MemView<Val extends Value, Type extends TypeNode = TypeNode> extends View<Memory | Storage, Val, bigint, Type> {
    constructor(
        type: Type,
        infer: InferType,
        loc: bigint
 ...
 */
export abstract class StackView<Val extends Value, Type extends TypeNode = TypeNode> extends View<Stack, Val, number, Type> {
    constructor(
        type: Type,
        infer: InferType,
        loc: number
